...
package com.junderhill.TwoShotHDR;

import com.junderhill.TwoShotHDR.ServerDevice.ApiService;
import com.junderhill.TwoShotHDR.utils.SimpleHttpClient;
...
public class SimpleRemoteApi {
     ...
     * </pre>
     *
     * @param exposureIndexValue Exposure index value (For 1/3EV 6=2.0..-6=-2.00, for 1/2EV 6=3.0..-6=-3.0)
     * @return JSON data of response
     * @throws IOException all errors and exception are wrapped by this
     *             Exception.
     */
    public JSONObject setExposureCompensation(int exposureIndexValue) throws IOException {
        String service = "camera";
        try {
            JSONObject requestJson =
                    new JSONObject().put("method", "setExposureCompensation") //
                            .put("params", new JSONArray().put(exposureIndexValue)) //
                            .put("id", id()).put("version", "1.0");
            String url = findActionListUrl(service) + "/" + service;
